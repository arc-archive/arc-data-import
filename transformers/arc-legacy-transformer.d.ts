...
export {ArcLegacyTransformer};

/**
 * Transforms the first ARC data object to curent schema.
 */
declare class ArcLegacyTransformer extends BaseTransformer {
   ...
   */
  _transformRequests(requests: Array<object|null>|null, projects: Array<object|null>|null): Array<object|null>|null;
